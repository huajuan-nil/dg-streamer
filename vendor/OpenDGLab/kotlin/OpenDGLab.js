(function (_, Kotlin) {
  'use strict';
  var reversedArray = Kotlin.kotlin.collections.reversedArray_964n91$;
  ...
  KDataUtils.prototype.parseSetupData_964n8l$ = function (bArr) {
    ...
    }var g = this.byteArrayToString(reversedArray(bArr));
    return new Int32Array([toInt(g.substring(5, 16), 2), toInt(g.substring(16), 2)]);
  };
  function KDataUtils$byteArrayToString$lambda(this$KDataUtils) {
    return function (it) {
      return this$KDataUtils.commonBitwiseParse_0(it);
    };
  }
  KDataUtils.prototype.byteArrayToString = function (bArr) {
    return joinToString(asList(bArr), '', void 0, void 0, void 0, void 0, KDataUtils$byteArrayToString$lambda(this));
  };
  function KDataUtils$commonBitwiseParse$lambda(closure$b) {
    return function (it) {
      return toByte(closure$b >> it & 1).toString();
    };
  }
  KDataUtils.prototype.commonBitwiseParse_0 = function (b) {
    return joinToString(downTo(7, 0), '', void 0, void 0, void 0, void 0, KDataUtils$commonBitwiseParse$lambda(b));
  };
  KDataUtils.prototype.changePower_vux9f0$ = function (i, i2) {
    var binaryString = toString(i, 2);
    var binaryString2 = toString(i2, 2);
    binaryString = padStart(binaryString, 11, 48);
    binaryString2 = padStart(binaryString2, 11, 48);
  ...
  KDataUtils.prototype.convertStringToByteArray = function (str) {
    ...
    for (tmp$ = 0; tmp$ !== $receiver.length; ++tmp$) {
      ...
      var i2 = (tmp$_0 = index, index = tmp$_0 + 1 | 0, tmp$_0) * 8 | 0;
      var endIndex = i2 + 8 | 0;
      tmp$_1.call(destination, this.bitStringToByte_0(str.substring(i2, endIndex)));
    }
    return reversedArray(toByteArray(destination));
  };
  KDataUtils.prototype.bitStringToByte_0 = function (str) {
    var tmp$;
    if (str == null)
      ...
      try {
        switch (str.charCodeAt(0)) {
          case 48:
            tmp$ = toByte(toInt(str, 2));
            break;
          case 49:
            tmp$ = toByte(toInt(str, 2) - 256 | 0);
            break;
          default:tmp$ = 0;
            break;
        }
  ...
  KDataUtils.prototype.getABPower_hnzlub$ = function (bArr, f907j) {
    ...
    var parseInt2 = toInt(g.substring(2, 13), 2);
  ...
  var WaveBank_instance = null;
  function WaveBank_getInstance() {
    if (WaveBank_instance === null) {
      new WaveBank();
    }return WaveBank_instance;
  }
  function WaveCenter() {
  ...
  WaveCenter$Companion.prototype.getBasicWave = function (name) {
    return WaveBank_getInstance().basic.get_11rb$(name);
  };
  WaveCenter$Companion.prototype.getTouchWave = function (name) {
    return WaveBank_getInstance().touch.get_11rb$(name);
  };
  WaveCenter$Companion.prototype.getRandomTouchWave = function () {
    var tmp$;
    var name = random(WaveBank_getInstance().touch.keys, Random.Default);
    var tmp$_0;
    if ((tmp$ = WaveBank_getInstance().touch.get_11rb$(name)) != null)
      tmp$_0 = tmp$;
    else {
  ...
  WaveCenter$Companion.prototype.getRandomBasicWave = function () {
    var tmp$;
    var name = random(WaveBank_getInstance().basic.keys, Random.Default);
    var tmp$_0;
    if ((tmp$ = WaveBank_getInstance().basic.get_11rb$(name)) != null)
      tmp$_0 = tmp$;
    else {
      throw IllegalStateException_init(''.toString());
    }
  ...
  WaveCenter$Companion.prototype.getTouchWaveList = function () {
    return copyToArray(WaveBank_getInstance().touch.keys);
  };
  WaveCenter$Companion.prototype.getBasicWaveList = function () {
    return copyToArray(WaveBank_getInstance().basic.keys);
  };
  ...
  WaveCenter.prototype.fromBasicWaveToByteArray_0 = function (wave) {
    ...
    switch (this.waveConstructB_0) {
      case 0:
        ...
        var binaryString = toString(pow, 2);
        var binaryString2 = toString(i7, 2);
        var binaryString3 = toString(numberToInt(this.f806r_0), 2);
      ...
      case 1:
        ...
        var binaryString4 = toString(0, 2);
        var binaryString5 = toString(0, 2);
        var binaryString6 = toString(0, 2);
  ...
  WaveCenter.prototype.fromTouchRawToByteArray_lu1900$ = function (x, y) {
    ...
    var binaryString = toString(pow3, 2);
    var binaryString2 = toString(i2, 2);
    var binaryString3 = toString(i3, 2);
    while (binaryString.length < 5) {
      binaryString = '0' + binaryString;
    }
    while (binaryString2.length < 10) {
  ...
  WaveCenter.prototype.fromTouchWaveToByteArray_0 = function (wave) {
    ...
    var binaryString4 = toString(ax, 2);
    var binaryString5 = toString(ay, 2);
    var binaryString6 = toString(az, 2);
    while (binaryString4.length < 5) {
      binaryString4 = '0' + binaryString4;
    }
    while (binaryString5.length < 10) {
  ...
  Object.defineProperty(_, 'WaveBank', {
    get: WaveBank_getInstance
  });
  ...
  Kotlin.defineModule('OpenDGLab', _);
  return _;
}(module.exports, require('kotlin')));

//# sourceMappingURL=OpenDGLab.js.map
